...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Hiếu Ngân - Trường PTDTBT Tiểu học Mậu Long - ĐT: 036 6833 601</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Hiếu Ngân - Trường PTDTBT Tiểu học Mậu Long - ĐT: 036 6833 3601</div>", unsafe_allow_html=True)
